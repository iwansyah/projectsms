<div>
    <div>
        <h3 style="float:left;">Data Sms Keluar</h3><span style="float:right;margin-top:25px;"><a href="sms/newSms"><img src="images/iconpack/add_16x16.gif"> New SMS</a></span>
    </div>
    <?php if(isset($mess)){echo $mess;}?>
        ...
        <form name="fcari" method="post" action="sms/cariData/outbox" onsubmit="return val()"> 
        ...
        <table class="cust">
            ...
            <?php if(isset($outbox)){$no = ($this->uri->segment(4)=='' ? '1':$this->uri->segment(4)+1); foreach($outbox->result() as $row){ ?>
